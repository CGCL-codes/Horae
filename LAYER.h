...
Layer::Layer(unsigned int granularity, unsigned int width, unsigned int depth, int fingerprintLength) {
	this->granularity = granularity;				// the granularity of the current layer
	this->width = width;							// the width of the matrix
	this->depth = depth;							// the depth of the matrix
	this->fingerprintLength = fingerprintLength; 	// fingerprint length
...
Layer::Layer(const Layer &layer) {
	this->granularity = 2 * layer.granularity;
	this->width = layer.width;
	this->depth = layer.depth;
	this->fingerprintLength = layer.fingerprintLength;
	this->n1 = layer.n1;
	this->n2 = layer.n2;
